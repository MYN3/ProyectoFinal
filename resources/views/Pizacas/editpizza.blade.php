  ...
  {!!Form::model([],['action'=>['pizzacontroller@update',$pizza->id],'method'=>'PUT'])!!}
                         ...
                         <div class="contact-info">
                                 <div class="form-group ">
                                     <input type="text" name="nombremer"  class="form-control br-radius-zero" id="nombremer"  placeholder="Nombre" value="{{$pizza->nombre}}"/>
                                 ...
                                 <div class="form-group ">
                                     <input type="text" name="preciomer" class="form-control br-radius-zero" id="preciomer"  placeholder="Precio" value="{{$pizza->precio}}"/>

                                 </div>

                                 <div class="form-group ">
                                     <input type="text" name="tamanoomer" class="form-control br-radius-zero" id="tamanoomer"  placeholder="Tamaño" value="{{$pizza->tamano}}""/>
